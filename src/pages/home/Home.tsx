...
export default function Home() {
  ...
  return (
    <div className="bg-slate-950 font-sans">
      ...
      {/* Scroll Fantasma para gerar a rolagem */}
      ...
      <div className="fixed top-0 left-0 w-full h-[100dvh] overflow-hidden z-10 bg-gray-50/30">
        ...
        <div className="absolute top-4 md:top-8 left-0 w-full z-40 flex justify-center px-4">
          ...
          <div className="md:hidden flex flex-col items-center w-full max-w-[240px]">
            ...
            {/* Lista Dropdown */}
            <div className={`w-full mt-2 bg-white/95 backdrop-blur-md border border-gray-200 rounded-2xl shadow-xl overflow-hidden transition-all duration-300 origin-top ${isMobileMenuOpen ? 'max-h-96 opacity-100 scale-y-100' : 'max-h-0 opacity-0 scale-y-95 border-transparent'}`}>
              <div className="flex flex-col py-2">
                {MENU_ITEMS.map((item) => (
                  <button
                    key={item.index}
                    onClick={() => scrollToSlide(item.index)}
                    className={`px-5 py-3 text-left font-bold text-xs transition-colors ${
                      currentSlideIndex === item.index ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:bg-gray-50'
                    }`}
                  >
                    {item.label}
                  </button>
          ...
          {/* Menu Desktop (Pílula Horizontal) */}
        ...
        >
          ...
          {/* SLIDE 1: RELACIONA */}
          <div className="w-screen h-full flex items-center justify-center px-4 sm:px-6 md:px-16 bg-blue-50 shrink-0 overflow-y-auto overflow-x-hidden">
            <div className="w-full max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-8 lg:gap-24 py-24 my-auto">
              <div className="flex-1 space-y-4 md:space-y-6 text-center lg:text-left order-2 lg:order-1">
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold text-blue-600 tracking-tight">Relaciona</h1>
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 leading-tight">Controle total da sua operação comercial.</h2>
                <div className="pt-2 md:pt-4">
                  <a href="#" className="inline-flex items-center justify-center lg:justify-start text-blue-600 font-bold text-base md:text-lg hover:text-blue-800 transition-colors group">
                    Conheça o sistema
          ...
          <div className="w-screen h-full flex items-center justify-center px-4 sm:px-6 md:px-16 bg-blue-50 shrink-0 overflow-y-auto overflow-x-hidden">
            <div className="w-full max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-8 lg:gap-24 py-24 my-auto">
              <div className="flex-1 space-y-4 md:space-y-6 text-center lg:text-left order-2 lg:order-1">
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold text-blue-600 tracking-tight">Gestão de Vendas</h1>
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 leading-tight">Acompanhe cada etapa do seu funil e feche mais negócios.</h2>
                <div className="pt-2 md:pt-4">
                  <a href="#" className="inline-flex items-center justify-center lg:justify-start text-blue-600 font-bold text-base md:text-lg hover:text-blue-800 transition-colors group">
                    Explorar funil
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform"><polyline points="9 18 15 12 9 6"></polyline></svg>
          ...
          <div className="w-screen h-full flex items-center justify-center px-4 sm:px-6 md:px-16 bg-blue-50 shrink-0 overflow-y-auto overflow-x-hidden">
            <div className="w-full max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-8 lg:gap-24 py-24 my-auto">
              <div className="flex-1 space-y-4 md:space-y-6 text-center lg:text-left order-2 lg:order-1">
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold text-blue-600 tracking-tight">Dados Precisos</h1>
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 leading-tight">Tome decisões baseadas em relatórios gerados em tempo real.</h2>
                <div className="pt-2 md:pt-4">
                  <a href="#" className="inline-flex items-center justify-center lg:justify-start text-blue-600 font-bold text-base md:text-lg hover:text-blue-800 transition-colors group">
                    Ver relatórios
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform"><polyline points="9 18 15 12 9 6"></polyline></svg>
          ...
          <div className="w-screen h-full flex items-center justify-center px-4 sm:px-6 md:px-16 bg-blue-50 shrink-0 overflow-y-auto overflow-x-hidden">
            <div className="w-full max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-8 lg:gap-24 py-24 my-auto">
              <div className="flex-1 space-y-4 md:space-y-6 text-center lg:text-left order-2 lg:order-1">
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold text-blue-600 tracking-tight">Trabalho Colaborativo</h1>
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 leading-tight">Organize permissões, delegue tarefas e unifique seu time.</h2>
                <div className="pt-2 md:pt-4">
                  <a href="#" className="inline-flex items-center justify-center lg:justify-start text-blue-600 font-bold text-base md:text-lg hover:text-blue-800 transition-colors group">
                    Gerenciar time
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform"><polyline points="9 18 15 12 9 6"></polyline></svg>
          ...
          <div className="w-screen h-full flex items-center justify-center bg-blue-50 border-l border-gray-100 shrink-0 overflow-y-auto">
            <div className="w-full px-4 sm:px-6 md:px-16 max-w-7xl mx-auto py-24 my-auto">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 md:mb-12 gap-4 md:gap-6">
                <div>
                  <h2 className="text-3xl md:text-4xl font-bold text-blue-600 mb-2 md:mb-3">Tudo o que seu time precisa</h2>
                  <p className="text-gray-600 text-lg md:text-xl">Deslize para ver as funcionalidades desenvolvidas para o seu comercial.</p>
                </div>
              ...
              <div ref={featureCarouselRef} className="flex overflow-x-auto snap-x snap-mandatory gap-4 md:gap-6 pb-8 scroll-smooth [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] scrollbar-none">
                {[
                  ...
                  <div key={index} className="snap-start shrink-0 w-[85vw] sm:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)]">
          ...
          <div className="w-screen h-full flex items-center justify-center bg-blue-50 border-l border-gray-100 shrink-0 overflow-y-auto">
            <div className="w-full px-4 sm:px-6 md:px-16 max-w-7xl mx-auto py-24 my-auto">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 md:mb-10 gap-4 md:gap-6">
                <div>
                  <h2 className="text-3xl md:text-4xl font-bold text-blue-600 mb-2">Quem constrói o Relaciona</h2>
                  <p className="text-gray-600 text-lg">Conheça as mentes por trás do desenvolvimento do nosso CRM.</p>
                </div>
              </div>
              <div ref={teamCarouselRef} className="flex overflow-x-auto snap-x snap-mandatory gap-6 md:gap-10 pb-8 pt-4 px-2 scroll-smooth [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] scrollbar-none">
                {TEAM_MEMBERS.map((member, index) => (
                  <div key={index} className="snap-start shrink-0 w-[85vw] sm:w-[320px] flex">
                    <TeamCard {...member} />
                  </div>
                ))}
              </div>
          ...
          <div className="w-screen h-full flex items-center justify-center bg-blue-50 text-blue-600 relative shrink-0 overflow-hidden">
            ...
            <div className="w-full px-4 sm:px-6 md:px-16 max-w-7xl mx-auto relative z-10 py-24 my-auto">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 md:mb-12 gap-4 md:gap-6">
                <div>
                  <h2 className="text-3xl md:text-4xl font-bold mb-2 md:mb-3">Quem usa, recomenda</h2>
                  <p className="text-slate-500 text-lg md:text-xl">Veja como o Relaciona tem transformado o processo comercial de outras empresas.</p>
                </div>
                <div className="hidden md:flex gap-3">
                  <button onClick={() => scroll(testimonialCarouselRef, 'left')} className="p-3 bg-blue-600 border border-blue-600 rounded-full text-slate-100 hover:text-white hover:border-blue-500 hover:bg-blue-700 transition-all"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5"><polyline points="15 18 9 12 15 6"></polyline></svg></button>
                  <button onClick={() => scroll(testimonialCarouselRef, 'right')} className="p-3 bg-blue-600 border border-blue-600 rounded-full text-slate-100 hover:text-white hover:border-blue-500 hover:bg-blue-700 transition-all"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5"><polyline points="9 18 15 12 9 6"></polyline></svg></button>
                </div>
              </div>
              <div ref={testimonialCarouselRef} className="flex overflow-x-auto snap-x snap-mandatory gap-4 md:gap-6 pb-8 scroll-smooth [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] scrollbar-none bg-blue-50">
                {[
            ...
            <div className="w-full px-4 sm:px-6 md:px-16 max-w-6xl mx-auto pt-24 pb-6 md:py-16 flex flex-col min-h-min md:h-full justify-between">
              ...
              <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 grow items-center w-full">
                <div className="flex-1 space-y-4 md:space-y-8 text-center lg:text-left w-full">
                  <h2 className="text-3xl md:text-5xl lg:text-5xl font-extrabold text-blue-600">Pronto para transformar suas vendas?</h2>
                  ...
                  <div className="pt-2 md:pt-4 flex flex-col items-center lg:items-start">
                    <p className="text-xs md:text-sm font-bold text-slate-500 uppercase tracking-widest mb-3 md:mb-4">Siga nossas redes</p>
                    <div className="flex gap-4">
                      <a href="#" className="w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center text-slate-400 hover:text-blue-500 hover:border-blue-500 transition-colors">
                        <svg viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8 md:w-10 md:h-10"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" /></svg>
                      </a>
                      <a href="#" className="w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center text-slate-400 hover:text-blue-500 hover:border-blue-500 transition-colors">
                        <svg viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8 md:w-10 md:h-10"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" /></svg>
                      </a>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex-1 w-full h-100 max-w-md mx-auto ">
                  <form className="bg-white p-6 md:p-8 rounded-3xl border border-gray-100 shadow-xl flex flex-col gap-3 md:gap-4">
                    <div>
                      ...
                      <input type="text" placeholder="Ex: Maria Silva" className="w-full border border-gray-200 rounded-xl px-4 py-2.5 md:py-3 text-gray-900 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all bg-gray-50" />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-blue-950 mb-1.5">E-mail corporativo</label>
                      <input type="email" placeholder="maria@empresa.com" className="w-full border border-gray-200 rounded-xl px-4 py-2.5 md:py-3 text-gray-900 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all bg-gray-50" />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-blue-950 mb-1.5">Mensagem</label>
                      <textarea rows={3} placeholder="Como podemos ajudar?" className="w-full border border-gray-200 rounded-xl px-4 py-2.5 md:py-3 text-gray-900 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all resize-none bg-gray-50"></textarea>
                    </div>
                    <button type="button" className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 md:py-3.5 px-6 rounded-xl transition-all mt-2">
                      Enviar mensagem
                    </button>
                  </form>
                </div>
              ...
              <div className="w-full pt-6 md:pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4 text-xs md:text-sm text-blue-600 mt-8 md:mt-12">
                ...
                <p className="text-slate-500 text-center md:text-left">© 2026 Relaciona CRM. Todos os direitos reservados.</p>
