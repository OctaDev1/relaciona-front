        ...
        >
          ...
          <div className="w-screen h-full flex items-center justify-center px-4 sm:px-6 md:px-10 lg:px-16 bg-blue-50 shrink-0">
            <div className="w-full max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-8 sm:gap-12 lg:gap-24 pt-16">
              ...
              <div className="flex-1 w-full flex justify-center">
                <div className={`w-full max-w-[220px] sm:max-w-sm md:max-w-lg aspect-4/3 rounded-4xl bg-linear-to-br from-blue-100 to-blue-50 shadow-2xl border border-gray-100 flex items-center justify-center p-4 sm:p-6 md:p-8`}>
                  <img
          ...
          <div className="w-screen h-full flex items-center justify-center px-4 sm:px-6 md:px-10 lg:px-16 bg-blue-50 shrink-0">
            <div className="w-full max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-8 sm:gap-12 lg:gap-24 pt-16">
              ...
              <div className="flex-1 w-full flex justify-center">
                <div className={`w-full max-w-[220px] sm:max-w-sm md:max-w-lg aspect-4/3 rounded-4xl bg-linear-to-br from-cyan-100 to-blue-50 shadow-2xl border border-gray-100 flex items-center justify-center p-4 sm:p-6 md:p-8`}>
                  <div className="w-20 h-20 sm:w-28 sm:h-28 md:w-32 md:h-32 bg-white rounded-full shadow-lg flex items-center justify-center text-blue-500">
          ...
          <div className="w-screen h-full flex items-center justify-center px-4 sm:px-6 md:px-10 lg:px-16 bg-blue-50 shrink-0">
            <div className="w-full max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-8 sm:gap-12 lg:gap-24 pt-16">
              ...
              <div className="flex-1 w-full flex justify-center">
                <div className={`w-full max-w-[220px] sm:max-w-sm md:max-w-lg aspect-4/3 rounded-4xl bg-linear-to-br from-indigo-100 to-blue-50 shadow-2xl border border-gray-100 flex items-center justify-center p-4 sm:p-6 md:p-8`}>
                  <div className="w-20 h-20 sm:w-28 sm:h-28 md:w-32 md:h-32 bg-white rounded-full shadow-lg flex items-center justify-center text-blue-500">
                    {getTabIcon('metricas')}
                  </div>
                </div>
          ...
          <div className="w-screen h-full flex items-center justify-center px-4 sm:px-6 md:px-10 lg:px-16 bg-blue-50 shrink-0">
            <div className="w-full max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-8 sm:gap-12 lg:gap-24 pt-16">
              ...
              <div className="flex-1 w-full flex justify-center">
                <div className={`w-full max-w-[220px] sm:max-w-sm md:max-w-lg aspect-4/3 rounded-4xl bg-linear-to-br from-sky-100 to-white shadow-2xl border border-gray-100 flex items-center justify-center p-4 sm:p-6 md:p-8`}>
                  <div className="w-20 h-20 sm:w-28 sm:h-28 md:w-32 md:h-32 bg-white rounded-full shadow-lg flex items-center justify-center text-blue-500">
                    {getTabIcon('equipe')}
                  </div>
                </div>
